...
public class listKidsProducts extends AppCompatActivity {

    private ListView listado;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_list_kids_products);
        getSupportActionBar().hide();
        listado = (ListView)findViewById(R.id.listView4);
        ObtDato();
    }
    ...
    public void ObtDato(){
        ...
        String url="http://systemxlr.96.lt/FastPrice/productsForKids.php";
