...
public class listSustancias extends AppCompatActivity {
    private ListView listado;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_list_sustancias);
        getSupportActionBar().hide();
        listado = (ListView)findViewById(R.id.listView3);
        ObtDato();
    }
    ...
    public void ObtDato(){
        ...
        String url="http://systemxlr.96.lt/FastPrice/allSustancias.php";
